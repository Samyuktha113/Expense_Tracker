...
<div class="wrapper">
    <div class="row">
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #95D2B3; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #939185; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #E7F0DC; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #F6E6CB; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #F7F9F2; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #E8C5E5; color: white;">
                <div class="counter">
